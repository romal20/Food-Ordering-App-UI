      ...
      child: AnimatedBuilder(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              _CardImage(restaurant: widget.restaurant, width: widget.width),
              _CardInfo(restaurant: widget.restaurant, isDark: widget.isDark),
            ],
          ),
        ),
      ),
...
class _CardImage extends StatelessWidget {
  ...
  const _CardImage({required this.restaurant, required this.width});
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        // Offer badge — gradient orange pill top-left
        ...
        // Rating badge — green pill bottom-left
        Positioned(
          bottom: 8,
          left: 8,
          child: Container(
...
class _DeliveryRowState extends State<_DeliveryRow>
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      // Touch deliveryLabelIndex to subscribe
        ...
        child: Row(
          children: [
            Icon(
              ...
              size: 13,
              color: isNF ? const Color(0xFF22C55E) : textSecondary,
            ),
            const SizedBox(width: 3),
            Text(
              label,
...
class FoodCardShimmer extends StatelessWidget {
  ...
  const FoodCardShimmer({super.key, required this.width, required this.isDark});
